...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-user-edit mr-2 text-primary"></i>Edit Ustadz/Ustadzah
    </h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    <i class="fas fa-edit mr-1"></i> Form Edit Ustadz/Ustadzah
                </h6>
            </div>
            <div class="card-body">
                <?= form_open('ustadz/edit/'.$ustadz->id, ['class' => 'needs-validation', 'novalidate' => '', 'id' => 'form-ustadz']) ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('nama') ? 'is-invalid' : '' ?>" 
                               id="nama" name="nama" value="<?= set_value('nama', $ustadz->nama) ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control <?= form_error('nomor_telepon') ? 'is-invalid' : '' ?>" 
                               id="nomor_telepon" name="nomor_telepon" value="<?= set_value('nomor_telepon', $ustadz->nomor_telepon) ?>" 
