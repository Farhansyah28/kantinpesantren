            ...
            <div class="card">
                <div class="card-header py-2 bg-gradient-warning">
                    <h3 class="card-title mb-0">
                        <i class="fas fa-user-edit mr-1"></i> Form Edit Santri
                    </h3>
                ...
                <div class="card-body py-3">
                    <?= form_open('santri/update/'.$santri->id, ['id' => 'form-santri']) ?>
                        <div class="row">
                            <!-- Data Santri -->
                            <div class="col-md-6">
                                ...
                                <div class="form-group row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" 
                                               ...
                                               id="nomor_induk" 
                                               name="nomor_induk" 
                                               value="<?= set_value('nomor_induk', $santri->nomor_induk, TRUE) ?>" 
                                ...
                                <div class="form-group row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" 
                                               ...
                                               id="nama" 
                                               name="nama" 
                                               value="<?= set_value('nama', $santri->nama, TRUE) ?>" 
                                ...
                                <div class="form-group row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" 
                                               ...
                                               id="kelas" 
                                               name="kelas" 
                                               value="<?= set_value('kelas', $santri->kelas, TRUE) ?>" 
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control form-control-sm <?= form_error('jenis_kelamin') ? 'is-invalid' : '' ?>" 
                                            ...
                                            <?php if ($this->session->userdata('kantin_id') == 1): ?>
                                                <option value="L" <?= set_select('jenis_kelamin', 'L', $santri->jenis_kelamin=='L') ?>>Laki-laki</option>
                                            <?php elseif ($this->session->userdata('kantin_id') == 2): ?>
                                                <option value="P" <?= set_select('jenis_kelamin', 'P', $santri->jenis_kelamin=='P') ?>>Perempuan</option>
                                            <?php else: ?>
                                                <option value="L" <?= set_select('jenis_kelamin', 'L', $santri->jenis_kelamin=='L') ?>>Laki-laki</option>
                                                <option value="P" <?= set_select('jenis_kelamin', 'P', $santri->jenis_kelamin=='P') ?>>Perempuan</option>
                                            <?php endif; ?>
                                ...
                                <div class="form-group row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" 
                                               ...
                                               id="nama_wali" 
                                               name="nama_wali" 
                                               value="<?= set_value('nama_wali', $santri->nama_wali, TRUE) ?>" 
                                ...
                                <div class="form-group row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" 
                                               ...
                                               id="kontak_wali" 
                                               name="kontak_wali" 
                                               value="<?= set_value('kontak_wali', $santri->kontak_wali, TRUE) ?>" 
                                ...
                                <div class="form-group row mb-2 align-items-center">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control form-control-sm <?= form_error('hubungan_wali') ? 'is-invalid' : '' ?>" 
                                            ...
                                            <option value="Ayah" <?= set_select('hubungan_wali', 'Ayah', $santri->hubungan_wali == 'Ayah') ?>>Ayah</option>
                                            <option value="Ibu" <?= set_select('hubungan_wali', 'Ibu', $santri->hubungan_wali == 'Ibu') ?>>Ibu</option>
                                            <option value="Wali" <?= set_select('hubungan_wali', 'Wali', $santri->hubungan_wali == 'Wali') ?>>Wali</option>
                                            <option value="Kakak" <?= set_select('hubungan_wali', 'Kakak', $santri->hubungan_wali == 'Kakak') ?>>Kakak</option>
                                            <option value="Lainnya" <?= set_select('hubungan_wali', 'Lainnya', $santri->hubungan_wali == 'Lainnya') ?>>Lainnya</option>
                                        </select>
