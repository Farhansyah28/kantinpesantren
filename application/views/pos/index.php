            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">POS Kantin</li>
                    </ol>
                </div>
            </div>
            <!-- Action Buttons -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="transaction_summary">
                    <!-- Ringkasan transaksi akan ditampilkan di sini -->
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <button type="button" class="btn btn-success" id="confirm_transaction">
...
$(document).ready(function() {
    ...
    $('#process_transaction').click(function() {
        ...
        $.post('<?= base_url("pos/process_transaction") ?>', postData, function(response) {
    ...
    function showTransactionSummary() {
        ...
        let summary = `
            <div class="row">
                <div class="col-md-6">
                    ...
                    ${selectedSantri.nama}<br>
                    ${selectedSantri.nomor_induk} - ${selectedSantri.kelas}
                </div>
                <div class="col-md-6">
                    <strong>Saldo:</strong> Rp ${numberFormat(selectedSantri.saldo_jajan)}<br>
                    <strong>Total Transaksi:</strong> Rp ${numberFormat(cart.reduce((sum, item) => sum + item.subtotal, 0))}
                </div>
            </div>
            <hr>
        ...
        summary += `
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-right">Rp ${numberFormat(total)}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        $('#transaction_summary').html(summary);
    ...
    // Load data awal
    // Tidak perlu lagi memuat menu populer atau transaksi terakhir
});
</script> 