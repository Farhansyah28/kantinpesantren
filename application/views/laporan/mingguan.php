...
<div class="d-sm-flex align-items-center justify-content-between mb-3">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-chart-bar mr-2"></i>Laporan Transaksi Mingguan
    </h1>
    ...
    <div class="col-lg-12">
        <div class="card shadow">
            ...
            <div class="card-body py-3">
                <form method="GET" action="<?= base_url('laporan/mingguan') ?>" class="form-inline justify-content-center">
                    <div class="form-group mr-3">
                        <label for="minggu" class="mr-2 font-weight-bold text-gray-700">Pilih Minggu:</label>
                        <input type="week"
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-2 bg-gradient-info d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <?php else: ?>
                    <a href="<?= base_url('laporan/export_pdf_mingguan?minggu=' . $minggu . ($this->input->get('kantin') ? '&kantin=' . $this->input->get('kantin') : '')) ?>"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalExportPDFLabel">Export PDF Laporan Mingguan</h5>
                ...
                <div class="modal-body">
                    <form id="formExportPDF">
                        <div class="form-group">
                            <label for="kantin-pdf" class="font-weight-bold">Pilih Kantin</label>
                            <select class="form-control" id="kantin-pdf" name="kantin">
                                <option value="all">Gabung Semua Kantin</option>
                                <option value="putra">Kantin Putra</option>
                                <option value="putri">Kantin Putri</option>
                            </select>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger" id="btnExportPDF">Export PDF</button>
                </div>
            </div>
        </div>
    </div>
    <script>
        $(document).ready(function() {
            $('#btnExportPDF').click(function() {
                var minggu = "<?= $minggu ?>";
                var kantin = $('#kantin-pdf').val();
                var url = "<?= base_url('laporan/export_pdf_mingguan?minggu=') ?>" + encodeURIComponent(minggu) + "&kantin=" + encodeURIComponent(kantin);
