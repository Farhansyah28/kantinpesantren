        ...
        <div class="card shadow">
            <div class="card-header py-2 bg-gradient-warning">
                <h6 class="m-0 font-weight-bold text-white">
                    <i class="fas fa-user-edit mr-1"></i> Form Edit User
                </h6>
            </div>
                    ...
                    <div class="form-group row mb-2 align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input type="text" 
                                   ...
                                   value="<?= set_value('username', $user->username, TRUE) ?>" 
                    ...
                    <div class="form-group row mb-2 align-items-center">
                        ...
                        <div class="col-sm-9">
                            <select name="role" 
                                ...
                                <option value="keuangan" <?= set_select('role','keuangan', $user->role=='keuangan') ?>>Keuangan</option>
                                <option value="santri" <?= set_select('role','santri', $user->role=='santri') ?>>Santri</option>
                            </select>
                    ...
                    <div class="form-group row mb-2 align-items-center" id="gender-group">
                        ...
                        <div class="col-sm-9">
                            <select name="gender" 
                                ...
                                <option value="L" <?= set_select('gender','L', $user->gender=='L') ?>>Laki-laki</option>
                                <option value="P" <?= set_select('gender','P', $user->gender=='P') ?>>Perempuan</option>
                            </select>
